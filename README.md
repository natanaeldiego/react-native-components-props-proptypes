## Exemplo usando componentes e validação com propTypes

## Example using components and validation with propTypes

## Screen Preview

## Preview da tela

![Hook Preview](https://raw.githubusercontent.com/natanaeldiego/react-native-components-props-proptypes/master/img/Screenshot.png)
...
> git clone https://github.com/natanaeldiego/react-native-components-props-proptypes.git

Go to project folder:  
Vá para a pasta do projeto:  
> cd react-native-components-props-proptypes
...
The .apk file is located at / O arquivo .apk está localizado em `react-native-components-props-proptypes/android/app/build/outputs/apk/app-release-unsigned.apk`
